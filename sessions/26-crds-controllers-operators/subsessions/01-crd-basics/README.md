# Sub-Session 01: Crd Basics

This sub-session is part of 26-crds-controllers-operators.

## Goal

CustomResourceDefinition and CustomResource.
...
```bash
kubectl apply -f subsessions/01-crd-basics/
```
...
```bash
kubectl delete -f subsessions/01-crd-basics/ --ignore-not-found
```
