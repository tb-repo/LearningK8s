# Sub-Session 06: Configmap Secret Generators
...
```bash
kubectl apply -f subsessions/06-configmap-secret-generators/
```
...
```bash
kubectl delete -f subsessions/06-configmap-secret-generators/ --ignore-not-found
```
