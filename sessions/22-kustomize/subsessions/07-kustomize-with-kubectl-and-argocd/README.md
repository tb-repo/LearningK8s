# Sub-Session 07: Kustomize With Kubectl And Argocd

This sub-session is part of 22-kustomize.

## Goal

apply and GitOps usage.
...
```bash
kubectl apply -f subsessions/07-kustomize-with-kubectl-and-argocd/
```
...
```bash
kubectl delete -f subsessions/07-kustomize-with-kubectl-and-argocd/ --ignore-not-found
```
