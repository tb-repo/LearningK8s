# Sub-Session 01: Kustomize Concepts

This sub-session is part of 22-kustomize.

## Goal

base, overlay, resource, patch.
...
```bash
kubectl apply -f subsessions/01-kustomize-concepts/
```
...
```bash
kubectl delete -f subsessions/01-kustomize-concepts/ --ignore-not-found
```
