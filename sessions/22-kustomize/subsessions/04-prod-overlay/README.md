# Sub-Session 04: Prod Overlay

This sub-session is part of 22-kustomize.

## Goal

production labels, replicas, resources.
...
```bash
kubectl apply -f subsessions/04-prod-overlay/
```
...
```bash
kubectl delete -f subsessions/04-prod-overlay/ --ignore-not-found
```
