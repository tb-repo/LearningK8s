# Sub-Session 03: Dev Overlay

This sub-session is part of 22-kustomize.

## Goal

small replicas and local settings.
...
```bash
kubectl apply -f subsessions/03-dev-overlay/
```
...
```bash
kubectl delete -f subsessions/03-dev-overlay/ --ignore-not-found
```
