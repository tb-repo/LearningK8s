# Sub-Session 01: Observability Model
...
```bash
kubectl apply -f subsessions/01-observability-model/
```
...
```bash
kubectl delete -f subsessions/01-observability-model/ --ignore-not-found
```
