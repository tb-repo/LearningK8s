# Sub-Session 08: Slo And Alert Design
...
```bash
kubectl apply -f subsessions/08-slo-and-alert-design/
```
...
```bash
kubectl delete -f subsessions/08-slo-and-alert-design/ --ignore-not-found
```
