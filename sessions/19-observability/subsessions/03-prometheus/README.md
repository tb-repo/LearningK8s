# Sub-Session 03: Prometheus

This sub-session is part of 19-observability.

## Goal

scraping app and cluster metrics.
...
```bash
kubectl apply -f subsessions/03-prometheus/
```
...
```bash
kubectl delete -f subsessions/03-prometheus/ --ignore-not-found
```
