# Sub-Session 01: Threat Model

This sub-session is part of 16-security-hardening.

## Goal

image, runtime, network, identity, and API risks.
...
```bash
kubectl apply -f subsessions/01-threat-model/
```
...
```bash
kubectl delete -f subsessions/01-threat-model/ --ignore-not-found
```
