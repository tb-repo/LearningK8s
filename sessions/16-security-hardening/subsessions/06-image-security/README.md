# Sub-Session 06: Image Security

This sub-session is part of 16-security-hardening.

## Goal

trusted registries and image scanning.
...
```bash
kubectl apply -f subsessions/06-image-security/
```
...
```bash
kubectl delete -f subsessions/06-image-security/ --ignore-not-found
```
