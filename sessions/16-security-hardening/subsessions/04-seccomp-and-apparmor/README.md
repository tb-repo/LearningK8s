# Sub-Session 04: Seccomp And Apparmor
...
```bash
kubectl apply -f subsessions/04-seccomp-and-apparmor/
```
...
```bash
kubectl delete -f subsessions/04-seccomp-and-apparmor/ --ignore-not-found
```
