# Sub-Session 03: Security Context

This sub-session is part of 16-security-hardening.

## Goal

users, groups, capabilities, privilege escalation.
...
```bash
kubectl apply -f subsessions/03-security-context/
```
...
```bash
kubectl delete -f subsessions/03-security-context/ --ignore-not-found
```
