# Sub-Session 02: Pod Security Standards
...
```bash
kubectl apply -f subsessions/02-pod-security-standards/
```
...
```bash
kubectl delete -f subsessions/02-pod-security-standards/ --ignore-not-found
```
