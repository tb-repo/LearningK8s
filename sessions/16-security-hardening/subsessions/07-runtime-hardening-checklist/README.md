# Sub-Session 07: Runtime Hardening Checklist
...
```bash
kubectl apply -f subsessions/07-runtime-hardening-checklist/
```
...
```bash
kubectl delete -f subsessions/07-runtime-hardening-checklist/ --ignore-not-found
```
