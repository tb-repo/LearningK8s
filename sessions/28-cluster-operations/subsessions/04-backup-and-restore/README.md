# Sub-Session 04: Backup And Restore

This sub-session is part of 28-cluster-operations.

## Goal

Velero and disaster recovery.
...
```bash
kubectl apply -f subsessions/04-backup-and-restore/
```
...
```bash
kubectl delete -f subsessions/04-backup-and-restore/ --ignore-not-found
```
