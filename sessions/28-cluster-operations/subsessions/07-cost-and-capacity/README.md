# Sub-Session 07: Cost And Capacity

This sub-session is part of 28-cluster-operations.

## Goal

rightsizing and cleanup.
...
```bash
kubectl apply -f subsessions/07-cost-and-capacity/
```
...
```bash
kubectl delete -f subsessions/07-cost-and-capacity/ --ignore-not-found
```
