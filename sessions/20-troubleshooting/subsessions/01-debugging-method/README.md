# Sub-Session 01: Debugging Method

This sub-session is part of 20-troubleshooting.

## Goal

observe, describe, isolate, fix, verify.
...
```bash
kubectl apply -f subsessions/01-debugging-method/
```
...
```bash
kubectl delete -f subsessions/01-debugging-method/ --ignore-not-found
```
