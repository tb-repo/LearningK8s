# Sub-Session 04: Service And Dns

This sub-session is part of 20-troubleshooting.

## Goal

no endpoints, wrong selector, CoreDNS issues.
...
```bash
kubectl apply -f subsessions/04-service-and-dns/
```
...
```bash
kubectl delete -f subsessions/04-service-and-dns/ --ignore-not-found
```
