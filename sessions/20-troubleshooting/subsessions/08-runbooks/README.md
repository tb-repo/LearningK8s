# Sub-Session 08: Runbooks

This sub-session is part of 20-troubleshooting.

## Goal

write fixes as operational runbooks.
...
```bash
kubectl apply -f subsessions/08-runbooks/
```
...
```bash
kubectl delete -f subsessions/08-runbooks/ --ignore-not-found
```
