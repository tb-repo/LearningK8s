# Sub-Session 05: Storage

This sub-session is part of 20-troubleshooting.

## Goal

PVC Pending, mount failures, zone mismatch.
...
```bash
kubectl apply -f subsessions/05-storage/
```
...
```bash
kubectl delete -f subsessions/05-storage/ --ignore-not-found
```
