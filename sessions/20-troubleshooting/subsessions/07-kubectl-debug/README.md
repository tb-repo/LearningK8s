# Sub-Session 07: Kubectl Debug

This sub-session is part of 20-troubleshooting.

## Goal

ephemeral containers and node debug.
...
```bash
kubectl apply -f subsessions/07-kubectl-debug/
```
...
```bash
kubectl delete -f subsessions/07-kubectl-debug/ --ignore-not-found
```
