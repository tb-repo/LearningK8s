# Sub-Session 03: Pending Pods

This sub-session is part of 20-troubleshooting.

## Goal

resources, selectors, taints, PVCs, topology.
...
```bash
kubectl apply -f subsessions/03-pending-pods/
```
...
```bash
kubectl delete -f subsessions/03-pending-pods/ --ignore-not-found
```
