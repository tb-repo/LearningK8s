# Sub-Session 04: Kyverno

This sub-session is part of 25-admission-control-and-policy.

## Goal

policy-as-code with Kubernetes-native YAML.
...
```bash
kubectl apply -f subsessions/04-kyverno/
```
...
```bash
kubectl delete -f subsessions/04-kyverno/ --ignore-not-found
```
