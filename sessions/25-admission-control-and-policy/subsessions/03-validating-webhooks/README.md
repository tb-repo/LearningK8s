# Sub-Session 03: Validating Webhooks
...
```bash
kubectl apply -f subsessions/03-validating-webhooks/
```
...
```bash
kubectl delete -f subsessions/03-validating-webhooks/ --ignore-not-found
```
