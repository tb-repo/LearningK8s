# Sub-Session 04: Traffic Management

This sub-session is part of 27-service-mesh.

## Goal

retries, timeouts, traffic splitting.
...
```bash
kubectl apply -f subsessions/04-traffic-management/
```
...
```bash
kubectl delete -f subsessions/04-traffic-management/ --ignore-not-found
```
