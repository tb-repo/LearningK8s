# Sub-Session 02: Install Istio Or Linkerd

This sub-session is part of 27-service-mesh.

## Goal

choose one mesh for the lab.
...
```bash
kubectl apply -f subsessions/02-install-istio-or-linkerd/
```
...
```bash
kubectl delete -f subsessions/02-install-istio-or-linkerd/ --ignore-not-found
```
