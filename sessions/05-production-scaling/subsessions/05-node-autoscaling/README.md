# Sub-Session 05: Node Autoscaling
...
kubectl apply -f subsessions/05-node-autoscaling/01-pending-pods-inflate.yml
```
...
```bash
kubectl apply -f subsessions/05-node-autoscaling/02-auto-mode-inflate.yml
```
...
```bash
kubectl apply -f subsessions/05-node-autoscaling/03-karpenter-nodepool-example.yml
kubectl get nodepools
...
```bash
kubectl apply -f subsessions/05-node-autoscaling/04-karpenter-inflate.yml
...
```bash
kubectl delete -f subsessions/05-node-autoscaling/04-karpenter-inflate.yml --ignore-not-found
kubectl delete -f subsessions/05-node-autoscaling/03-karpenter-nodepool-example.yml --ignore-not-found
```
...
```bash
kubectl apply -f subsessions/05-node-autoscaling/05-auto-mode-nodepool-example.yml
kubectl get nodepools
...
```bash
kubectl apply -f subsessions/05-node-autoscaling/06-auto-mode-custom-nodepool-inflate.yml
...
```bash
kubectl delete -f subsessions/05-node-autoscaling/06-auto-mode-custom-nodepool-inflate.yml --ignore-not-found
kubectl delete -f subsessions/05-node-autoscaling/05-auto-mode-nodepool-example.yml --ignore-not-found
```
