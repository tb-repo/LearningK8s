# Sub-Session 07: Chart Quality

This sub-session is part of 21-helm.

## Goal

linting, schema, notes, chart testing.
...
```bash
kubectl apply -f subsessions/07-chart-quality/
```
...
```bash
kubectl delete -f subsessions/07-chart-quality/ --ignore-not-found
```
