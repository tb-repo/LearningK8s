# Sub-Session 06: Upgrade And Rollback
...
```bash
kubectl apply -f subsessions/06-upgrade-and-rollback/
```
...
```bash
kubectl delete -f subsessions/06-upgrade-and-rollback/ --ignore-not-found
```
