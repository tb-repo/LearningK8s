# Sub-Session 08: Promotion

This sub-session is part of 29-supply-chain-cicd.

## Goal

dev, stage, production release flow.
...
```bash
kubectl apply -f subsessions/08-promotion/
```
...
```bash
kubectl delete -f subsessions/08-promotion/ --ignore-not-found
```
