# Sub-Session 01: Image Build

This sub-session is part of 29-supply-chain-cicd.

## Goal

Dockerfile quality and reproducible builds.
...
```bash
kubectl apply -f subsessions/01-image-build/
```
...
```bash
kubectl delete -f subsessions/01-image-build/ --ignore-not-found
```
