# Sub-Session 07: Cd Handoff

This sub-session is part of 29-supply-chain-cicd.

## Goal

update Helm/Kustomize and let Argo CD deploy.
...
```bash
kubectl apply -f subsessions/07-cd-handoff/
```
...
```bash
kubectl delete -f subsessions/07-cd-handoff/ --ignore-not-found
```
