# Sub-Session 02: Registry Flow

This sub-session is part of 29-supply-chain-cicd.

## Goal

ECR or Docker Hub tagging strategy.
...
```bash
kubectl apply -f subsessions/02-registry-flow/
```
...
```bash
kubectl delete -f subsessions/02-registry-flow/ --ignore-not-found
```
