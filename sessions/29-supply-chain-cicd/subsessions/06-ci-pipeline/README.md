# Sub-Session 06: Ci Pipeline

This sub-session is part of 29-supply-chain-cicd.

## Goal

GitHub Actions or Jenkins build pipeline.
...
```bash
kubectl apply -f subsessions/06-ci-pipeline/
```
...
```bash
kubectl delete -f subsessions/06-ci-pipeline/ --ignore-not-found
```
