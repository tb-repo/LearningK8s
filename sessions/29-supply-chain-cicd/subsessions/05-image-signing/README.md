# Sub-Session 05: Image Signing

This sub-session is part of 29-supply-chain-cicd.

## Goal

cosign and signature verification.
...
```bash
kubectl apply -f subsessions/05-image-signing/
```
...
```bash
kubectl delete -f subsessions/05-image-signing/ --ignore-not-found
```
