# Sub-Session 01: Application Manifests

This sub-session is part of 24-advanced-argocd.

## Goal

define Argo CD Applications as YAML.
...
```bash
kubectl apply -f subsessions/01-application-manifests/
```
...
```bash
kubectl delete -f subsessions/01-application-manifests/ --ignore-not-found
```
