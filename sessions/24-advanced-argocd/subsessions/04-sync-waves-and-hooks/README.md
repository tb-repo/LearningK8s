# Sub-Session 04: Sync Waves And Hooks
...
```bash
kubectl apply -f subsessions/04-sync-waves-and-hooks/
```
...
```bash
kubectl delete -f subsessions/04-sync-waves-and-hooks/ --ignore-not-found
```
