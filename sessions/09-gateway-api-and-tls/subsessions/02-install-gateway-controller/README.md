# Sub-Session 02: Install Gateway Controller

This sub-session is part of 09-gateway-api-and-tls.

## Goal

choose ALB, Envoy Gateway, Traefik, Istio, or Cilium.
...
```bash
kubectl apply -f subsessions/02-install-gateway-controller/
```
...
```bash
kubectl delete -f subsessions/02-install-gateway-controller/ --ignore-not-found
```
