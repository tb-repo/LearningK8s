# Sub-Session 05: Cert Manager

This sub-session is part of 09-gateway-api-and-tls.

## Goal

automate certificate requests.
...
```bash
kubectl apply -f subsessions/05-cert-manager/
```
...
```bash
kubectl delete -f subsessions/05-cert-manager/ --ignore-not-found
```
