# Sub-Session 06: Externaldns

This sub-session is part of 09-gateway-api-and-tls.

## Goal

automate public DNS records.
...
```bash
kubectl apply -f subsessions/06-externaldns/
```
...
```bash
kubectl delete -f subsessions/06-externaldns/ --ignore-not-found
```
