# Sub-Session 04: Tls Termination

This sub-session is part of 09-gateway-api-and-tls.

## Goal

attach certificates to Gateway listeners.
...
```bash
kubectl apply -f subsessions/04-tls-termination/
```
...
```bash
kubectl delete -f subsessions/04-tls-termination/ --ignore-not-found
```
