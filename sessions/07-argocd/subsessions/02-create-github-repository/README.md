...
```text
sessions/07-argocd/subsessions/02-create-github-repository/sample-repo/manifests/app.yml
```
...
cd argocd-demo-app
mkdir manifests
copy D:\teaching\batch16A\k8s\sessions\07-argocd\subsessions\02-create-github-repository\sample-repo\manifests\app.yml manifests\app.yml
git init
