# Sub-Session 06: Least Privilege

This sub-session is part of 15-eks-iam-integration.

## Goal

scoping AWS permissions per workload.
...
```bash
kubectl apply -f subsessions/06-least-privilege/
```
...
```bash
kubectl delete -f subsessions/06-least-privilege/ --ignore-not-found
```
