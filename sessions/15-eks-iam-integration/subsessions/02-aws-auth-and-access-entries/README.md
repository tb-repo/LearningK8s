# Sub-Session 02: Aws Auth And Access Entries

This sub-session is part of 15-eks-iam-integration.

## Goal

cluster access mapping.
...
```bash
kubectl apply -f subsessions/02-aws-auth-and-access-entries/
```
...
```bash
kubectl delete -f subsessions/02-aws-auth-and-access-entries/ --ignore-not-found
```
