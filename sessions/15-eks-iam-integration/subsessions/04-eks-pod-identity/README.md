# Sub-Session 04: Eks Pod Identity

This sub-session is part of 15-eks-iam-integration.

## Goal

modern EKS Pod Identity flow.
...
```bash
kubectl apply -f subsessions/04-eks-pod-identity/
```
...
```bash
kubectl delete -f subsessions/04-eks-pod-identity/ --ignore-not-found
```
