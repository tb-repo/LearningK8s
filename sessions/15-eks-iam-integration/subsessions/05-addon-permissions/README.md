# Sub-Session 05: Addon Permissions

This sub-session is part of 15-eks-iam-integration.

## Goal

EBS CSI, AWS Load Balancer Controller, ExternalDNS.
...
```bash
kubectl apply -f subsessions/05-addon-permissions/
```
...
```bash
kubectl delete -f subsessions/05-addon-permissions/ --ignore-not-found
```
