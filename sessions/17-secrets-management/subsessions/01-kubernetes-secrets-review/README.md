# Sub-Session 01: Kubernetes Secrets Review

This sub-session is part of 17-secrets-management.

## Goal

base64 encoding, mounts, env vars.
...
```bash
kubectl apply -f subsessions/01-kubernetes-secrets-review/
```
...
```bash
kubectl delete -f subsessions/01-kubernetes-secrets-review/ --ignore-not-found
```
