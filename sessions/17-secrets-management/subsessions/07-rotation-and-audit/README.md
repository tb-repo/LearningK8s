# Sub-Session 07: Rotation And Audit

This sub-session is part of 17-secrets-management.

## Goal

rotation patterns and access review.
...
```bash
kubectl apply -f subsessions/07-rotation-and-audit/
```
...
```bash
kubectl delete -f subsessions/07-rotation-and-audit/ --ignore-not-found
```
