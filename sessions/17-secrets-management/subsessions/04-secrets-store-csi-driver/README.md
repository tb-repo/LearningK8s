# Sub-Session 04: Secrets Store Csi Driver

This sub-session is part of 17-secrets-management.

## Goal

mount secrets directly from providers.
...
```bash
kubectl apply -f subsessions/04-secrets-store-csi-driver/
```
...
```bash
kubectl delete -f subsessions/04-secrets-store-csi-driver/ --ignore-not-found
```
